...
public class EsIndexDaoTest {
    ...
    public void testConnectEs6(){
        ...
        storeURL.getFilePath().put("krb5.conf", "/Users/haizhi/git/gp/graph/graph-dc/graph-dc-inbound/src/test/resources/fi/krb5.conf");
        storeURL.getFilePath().put("jaas.conf", "/Users/haizhi/git/gp/graph/graph-dc/graph-dc-inbound/src/test/resources/fi/jaas.conf");
        storeURL.getFilePath().put("user.keytab", "/Users/haizhi/git/gp/graph/graph-dc/graph-dc-inbound/src/test/resources/fi/user.keytab");
