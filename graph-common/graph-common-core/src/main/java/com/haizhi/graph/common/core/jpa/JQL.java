...
public class JQL {
    ...
    public static class SORT{
        public static final Sort UPDATED_DT_DESC = new Sort(new Sort.Order(Sort.Direction.DESC, "updatedDt"));
        public static final Sort CREATED_DT_DESC = new Sort(new Sort.Order(Sort.Direction.DESC, "createdDt"));
    }
}
