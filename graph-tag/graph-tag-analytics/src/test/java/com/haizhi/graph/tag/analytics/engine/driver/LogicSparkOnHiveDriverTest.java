...
public class LogicSparkOnHiveDriverTest {
    ...
    public void run() throws Exception {
        ...
        //flowTask.getPartitions().addPartition(Constants.PARTITION_DAY, DateUtils.getYesterday());
        System.out.println(JSON.toJSONString(flowTask, true));
        ...
        LogicSparkOnHiveDriver.main(args);
    }
}
