...
public class ReliableTaildirEventReader implements ReliableEventReader {
     ...
     */
    private ReliableTaildirEventReader(Map<String, FileFinder> filePaths,
        ...
        for (Entry<String, FileFinder> e : filePaths.entrySet()) {
            FileFinder fileFinder = e.getValue();
            if (fileFinder.getScanDir() == null){
                taildirCache.add(new TaildirMatcher(e.getKey(), e.getValue().getFilePattern(), cachePatternMatching));
            }else{
    ...
    public static class Builder {
        ...
        public Builder filePaths(Map<String, FileFinder> filePaths) {
